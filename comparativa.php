		...
		<nav>
  		...
  		<div class="row">
  			<div class="col s2 m2 l2">
  				<img class="responsive-img" alt="jumex.jpg" src="recursos/imagenes/jumex.jpg" width="300" height="300">
  			</div>
  			<div class="col s10 m10 l10">
  				<h1>Bebida JUMEX sabor manzana</h1>
  				<h2>Contenido neto: 500ml</h2>
  			</div>
  			<div class="row"></div>
  			<div class="row"></div>
  			<div class="row"></div>
  						...
  						<table class="bordered striped">
        					<tbody>
          						<tr>
						            ...
						            <td></td>
						            <td></td>
						            <td><h5>Wal-Mart México S.A DE C.V</h5></td>
						            <td></td>
						            <td></td>
						            <td></td>
						            <td></td>
