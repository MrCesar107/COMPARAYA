  		...
  		<div class="container">
  			<div class="row">
  				<div class="col s12 m12 l12">
  					<h1>Ofertas</h1>
            <h3>Descubre las mejores ofertas en tu localidad</h3>
  				</div>
  			</div>
  			<div class="row"></div>
  			<div class="row"></div>
              ...
              <h5 black-text>$11.55</h5>
  				...
  				<div class="col s12 m4 l2 center">
  					<img src="recursos/imagenes/sabritas.jpg" alt="jumex.jpg" width="100" height="100"><a href="comparativa3.php">Ver</a>
  					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi id diam ac tortor scelerisque rutrum eu eget ante.</p>
  					<div class="right">
              <h5 black-text>$7.21</h5>
  						<a class="btn-floating btn-large waves-effect waves-light red"><i class="material-icons">add</i></a>
  					</div>
  				</div>
  				<div class="col s12 m4 l2 center">
